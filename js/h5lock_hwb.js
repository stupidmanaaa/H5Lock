...
(function () {
    ...
    H5lock.prototype.initDom = function () {
        ...
        var str = '<h4 id="title" class="title">绘制解锁图案</h4><button style="position: absolute; bottom: 50px;" id="getPwd" onclick="getPwd(this)">获取密码</button>' +
    ...
    H5lock.prototype.init = function () {
        ...
        console.log("password :" + this.pswObj.spassword );
